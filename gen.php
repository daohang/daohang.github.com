...
$DH_output3 = str_replace("%home%",'http://dh.movie002.com/',$DH_output3);
$DH_output = str_replace("%cat%",'美观版本',$DH_output);
$DH_output3 = str_replace("%cat%",'精简版本',$DH_output3);

$DH_output_file = 'max.html';
